...
const App: React.FC<IStartGameProps> = ({isOpen}: {isOpen: boolean}) => {
    ...
    <Wrapper>
      <Container>
        ...
        {isOpen
          ...
          : (<NumCardSelectionViews isOpen={isOpen} handleGame={handleGame} numberOfCard={numberOfCard}  />)
        }
      </Container>
    </Wrapper>
  );
