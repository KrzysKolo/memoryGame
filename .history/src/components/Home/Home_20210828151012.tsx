...
// Styles
import { Grid, Wrapper } from './../../App.styles';
//Sound
import useSound from 'use-sound';
import sound2 from './../../sounds/app.mp3';
...
const Home: React.FC = () => {
  ...
  const [endingBoard, setEndingBoard] = useState(false);

  const [play] = useSound('./sounds/alarm.mp3');
  const [playApp] = useSound('./sounds/app.mp3');
